import urllib.request;import datetime;import time
import pickle;import sys as s;import urllib;
import requests

link = "https://cdn.star.nesdis.noaa.gov/GOES16/ABI/FD/AirMass/"
f = requests.get(link)
#print(f.text)
import urllib

def read_text():
      quotes = urllib.request.urlopen("https://cdn.star.nesdis.noaa.gov/GOES16/ABI/FD/AirMass/")
...
#Instant_source('02','1808x1808.jpg')
#Instant_source('04','1808x1808.jpg')
#Instant_source('06','1808x1808.jpg')
